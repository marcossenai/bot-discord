import { A as API } from './files-a4ec71a4.js';
...
declare class Client extends AsyncEventEmitter<ManagerShardEventsMap> {
     ...
     */
    requestGuildMembers(options: GatewayRequestGuildMembersData, timeout?: number): Promise<RequestGuildMembersResult>;
    /**
...
export { API, Client, ClientOptions, IntrinsicProps, ManagerShardEventsMap, MappedEvents, RequestGuildMembersResult, WithIntrinsicProps, version };
