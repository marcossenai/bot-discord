...
var ChannelsAPI = class {
  ...
  async createThread(channelId, body, messageId, { signal } = {}) {
    return this.rest.post(import_v102.Routes.threads(channelId, messageId), {
      body,
      signal
    });
  }
  ...
  async createForumThread(channelId, { message, ...optionsBody }, { signal } = {}) {
    ...
    return this.rest.post(import_v102.Routes.threads(channelId), { files, body, signal });
  }
  /**
  ...
  async createWebhook(channelId, body, { reason, signal } = {}) {
    return this.rest.post(import_v102.Routes.channelWebhooks(channelId), {
      reason,
      body,
      signal
    });
  ...
  async getWebhooks(channelId) {
    return this.rest.get(import_v102.Routes.channelWebhooks(channelId));
  }
  /**
  ...
  async editPermissionOverwrite(channelId, overwriteId, body, { reason, signal } = {}) {
    await this.rest.put(import_v102.Routes.channelPermission(channelId, overwriteId), {
      reason,
      body,
      signal
    });
  ...
  async deletePermissionOverwrite(channelId, overwriteId, { reason, signal } = {}) {
    await this.rest.delete(import_v102.Routes.channelPermission(channelId, overwriteId), {
      reason,
      signal
    });
  }
...
var StageInstancesAPI = class {
  ...
  async create(body, { reason, signal } = {}) {
    return this.rest.post(import_v108.Routes.stageInstances(), {
      body,
      reason,
      signal
    });
   ...
   */
  async get(channelId, { signal } = {}) {
    return this.rest.get(import_v108.Routes.stageInstance(channelId), { signal });
  }
  /**
  ...
  async edit(channelId, body, { reason, signal } = {}) {
    return this.rest.patch(import_v108.Routes.stageInstance(channelId), {
      body,
      reason,
      signal
    });
...
var StickersAPI = class {
  ...
  async getNitroStickers({ signal } = {}) {
    return this.rest.get(import_v109.Routes.nitroStickerPacks(), { signal });
  }
  /**
   * Fetches a sticker
   *
...
var ThreadsAPI = class {
  ...
  async join(threadId, { signal } = {}) {
    await this.rest.put(import_v1010.Routes.threadMembers(threadId, "@me"), { signal });
  }
  /**
  ...
  async addMember(threadId, userId, { signal } = {}) {
    await this.rest.put(import_v1010.Routes.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async leave(threadId, { signal } = {}) {
    await this.rest.delete(import_v1010.Routes.threadMembers(threadId, "@me"), { signal });
  }
  /**
  ...
  async removeMember(threadId, userId, { signal } = {}) {
    await this.rest.delete(import_v1010.Routes.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async getMember(threadId, userId, { signal } = {}) {
    return this.rest.get(import_v1010.Routes.threadMembers(threadId, userId), { signal });
  }
  /**
...
var UsersAPI = class {
  ...
  async get(userId, { signal } = {}) {
    return this.rest.get(import_v1011.Routes.user(userId), { signal });
  }
  /**
  ...
  async getCurrent({ signal } = {}) {
    return this.rest.get(import_v1011.Routes.user("@me"), { signal });
  }
  /**
  ...
  async getGuilds(query = {}, { signal } = {}) {
    return this.rest.get(import_v1011.Routes.userGuilds(), {
  ...
  async leaveGuild(guildId, { signal } = {}) {
    await this.rest.delete(import_v1011.Routes.userGuild(guildId), { signal });
  }
  /**
  ...
  async edit(body, { signal } = {}) {
    return this.rest.patch(import_v1011.Routes.user("@me"), { body, signal });
  }
  /**
  ...
  async getGuildMember(guildId, { signal } = {}) {
    return this.rest.get(import_v1011.Routes.userGuildMember(guildId), { signal });
  }
  /**
  ...
  async editCurrentGuildMember(guildId, body = {}, { reason, signal } = {}) {
    return this.rest.patch(import_v1011.Routes.guildMember(guildId, "@me"), {
      reason,
      body,
      signal
    });
  ...
  async createDM(userId, { signal } = {}) {
    return this.rest.post(import_v1011.Routes.userChannels(), {
  ...
  async getConnections({ signal } = {}) {
    return this.rest.get(import_v1011.Routes.userConnections(), { signal });
  }
  /**
  ...
  async getApplicationRoleConnection(applicationId, { signal } = {}) {
    return this.rest.get(import_v1011.Routes.userApplicationRoleConnection(applicationId), {
      signal
    });
  }
  /**
  ...
  async updateApplicationRoleConnection(applicationId, body, { signal } = {}) {
    return this.rest.put(import_v1011.Routes.userApplicationRoleConnection(applicationId), {
      body,
      signal
    });
  }
...
var WebhooksAPI = class {
  ...
  async execute(id, token, {
    ...
    return this.rest.post(import_v1013.Routes.webhook(id, token), {
  ...
  async executeSlack(id, token, body, query = {}, { signal } = {}) {
    await this.rest.post(import_v1013.Routes.webhookPlatform(id, token, "slack"), {
  ...
  async executeGitHub(id, token, body, query = {}, { signal } = {}) {
    await this.rest.post(import_v1013.Routes.webhookPlatform(id, token, "github"), {
      query: (0, import_rest7.makeURLSearchParams)(query),
      body,
      signal,
      auth: false
  ...
  async getMessage(id, token, messageId, query = {}, { signal } = {}) {
    return this.rest.get(import_v1013.Routes.webhookMessage(id, token, messageId), {
      query: (0, import_rest7.makeURLSearchParams)(query),
      auth: false,
      signal
    });
  ...
  async editMessage(id, token, messageId, {
    ...
    return this.rest.patch(import_v1013.Routes.webhookMessage(id, token, messageId), {
  ...
  async deleteMessage(id, token, messageId, query = {}, { signal } = {}) {
    await this.rest.delete(import_v1013.Routes.webhookMessage(id, token, messageId), {
      query: (0, import_rest7.makeURLSearchParams)(query),
      auth: false,
      signal
    });
...
var Client = class extends import_async_event_emitter.AsyncEventEmitter {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      const handler = /* @__PURE__ */ __name(({ data }) => {
        ...
        if (data.chunk_index >= data.chunk_count - 1) {
          this.off(import_v1014.GatewayDispatchEvents.GuildMembersChunk, handler);
          resolve({ members, nonce, notFound, presences });
        }
      }, "handler");
      this.on(import_v1014.GatewayDispatchEvents.GuildMembersChunk, handler);
    });
    await this.gateway.send(shardId, {
      op: import_v1014.GatewayOpcodes.RequestGuildMembers,
  ...
  async updateVoiceState(options) {
    const shardId = (0, import_util.calculateShardId)(options.guild_id, await this.gateway.getShardCount());
    await this.gateway.send(shardId, {
      op: import_v1014.GatewayOpcodes.VoiceStateUpdate,
      // eslint-disable-next-line id-length
      d: options
    });
  }
  ...
  async updatePresence(shardId, options) {
    await this.gateway.send(shardId, {
      op: import_v1014.GatewayOpcodes.PresenceUpdate,
      // eslint-disable-next-line id-length
      d: options
    });
  }
