...
var ChannelsAPI = class {
  ...
  async createThread(channelId, body, messageId, { signal } = {}) {
    return this.rest.post(Routes2.threads(channelId, messageId), {
      body,
      signal
    });
  }
  ...
  async createForumThread(channelId, { message, ...optionsBody }, { signal } = {}) {
    ...
    return this.rest.post(Routes2.threads(channelId), { files, body, signal });
  }
  /**
  ...
  async createWebhook(channelId, body, { reason, signal } = {}) {
    return this.rest.post(Routes2.channelWebhooks(channelId), {
      reason,
      body,
      signal
    });
  ...
  async getWebhooks(channelId) {
    return this.rest.get(Routes2.channelWebhooks(channelId));
  }
  /**
  ...
  async editPermissionOverwrite(channelId, overwriteId, body, { reason, signal } = {}) {
    await this.rest.put(Routes2.channelPermission(channelId, overwriteId), {
      reason,
      body,
      signal
    });
  ...
  async deletePermissionOverwrite(channelId, overwriteId, { reason, signal } = {}) {
    await this.rest.delete(Routes2.channelPermission(channelId, overwriteId), {
      reason,
      signal
    });
  }
...
var GuildsAPI = class {
  ...
  async getMemberBan(guildId, userId, { signal } = {}) {
    return this.rest.get(Routes3.guildBan(guildId, userId), { signal });
  }
  /**
  ...
  async removeMember(guildId, userId, { reason, signal } = {}) {
    return this.rest.delete(Routes3.guildMember(guildId, userId), { reason, signal });
  }
  /**
  ...
  async getOnboarding(guildId, { signal } = {}) {
    return this.rest.get(Routes3.guildOnboarding(guildId), { signal });
  }
};
...
var StageInstancesAPI = class {
  ...
  async create(body, { reason, signal } = {}) {
    return this.rest.post(Routes8.stageInstances(), {
      body,
      reason,
      signal
    });
   ...
   */
  async get(channelId, { signal } = {}) {
    return this.rest.get(Routes8.stageInstance(channelId), { signal });
  }
  /**
  ...
  async edit(channelId, body, { reason, signal } = {}) {
    return this.rest.patch(Routes8.stageInstance(channelId), {
      body,
      reason,
      signal
    });
  ...
  async delete(channelId, { reason, signal } = {}) {
    await this.rest.delete(Routes8.stageInstance(channelId), { reason, signal });
  }
};
...
var StickersAPI = class {
  ...
  async getNitroStickers({ signal } = {}) {
    return this.rest.get(Routes9.nitroStickerPacks(), { signal });
  }
  /**
   * Fetches a sticker
   *
  ...
  async get(stickerId, { signal } = {}) {
    return this.rest.get(Routes9.sticker(stickerId), { signal });
  }
};
...
var ThreadsAPI = class {
  ...
  async join(threadId, { signal } = {}) {
    await this.rest.put(Routes10.threadMembers(threadId, "@me"), { signal });
  }
  /**
  ...
  async addMember(threadId, userId, { signal } = {}) {
    await this.rest.put(Routes10.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async leave(threadId, { signal } = {}) {
    await this.rest.delete(Routes10.threadMembers(threadId, "@me"), { signal });
  }
  /**
  ...
  async removeMember(threadId, userId, { signal } = {}) {
    await this.rest.delete(Routes10.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async getMember(threadId, userId, { signal } = {}) {
    return this.rest.get(Routes10.threadMembers(threadId, userId), { signal });
  }
  /**
  ...
  async getAllMembers(threadId, { signal } = {}) {
    return this.rest.get(Routes10.threadMembers(threadId), { signal });
  }
};
...
var UsersAPI = class {
  ...
  async get(userId, { signal } = {}) {
    return this.rest.get(Routes11.user(userId), { signal });
  }
  /**
  ...
  async getCurrent({ signal } = {}) {
    return this.rest.get(Routes11.user("@me"), { signal });
  }
  /**
  ...
  async getGuilds(query = {}, { signal } = {}) {
    return this.rest.get(Routes11.userGuilds(), {
  ...
  async leaveGuild(guildId, { signal } = {}) {
    await this.rest.delete(Routes11.userGuild(guildId), { signal });
  }
  /**
  ...
  async edit(body, { signal } = {}) {
    return this.rest.patch(Routes11.user("@me"), { body, signal });
  }
  /**
  ...
  async getGuildMember(guildId, { signal } = {}) {
    return this.rest.get(Routes11.userGuildMember(guildId), { signal });
  }
  /**
  ...
  async editCurrentGuildMember(guildId, body = {}, { reason, signal } = {}) {
    return this.rest.patch(Routes11.guildMember(guildId, "@me"), {
      reason,
      body,
      signal
    });
  ...
  async createDM(userId, { signal } = {}) {
    return this.rest.post(Routes11.userChannels(), {
  ...
  async getConnections({ signal } = {}) {
    return this.rest.get(Routes11.userConnections(), { signal });
  }
  /**
  ...
  async getApplicationRoleConnection(applicationId, { signal } = {}) {
    return this.rest.get(Routes11.userApplicationRoleConnection(applicationId), {
      signal
    });
  }
  /**
  ...
  async updateApplicationRoleConnection(applicationId, body, { signal } = {}) {
    return this.rest.put(Routes11.userApplicationRoleConnection(applicationId), {
      body,
      signal
    });
  }
...
var VoiceAPI = class {
  ...
  async getVoiceRegions({ signal } = {}) {
    return this.rest.get(Routes12.voiceRegions(), { signal });
  }
};
...
var WebhooksAPI = class {
  ...
  async get(id, { token, signal } = {}) {
    return this.rest.get(Routes13.webhook(id, token), {
      signal,
      auth: !token
    });
  }
  ...
  async edit(id, body, { token, reason, signal } = {}) {
    return this.rest.patch(Routes13.webhook(id, token), {
      reason,
      body,
      signal,
      auth: !token
  ...
  async delete(id, { token, reason, signal } = {}) {
    await this.rest.delete(Routes13.webhook(id, token), {
      reason,
      signal,
      auth: !token
    });
  ...
  async execute(id, token, {
    ...
    return this.rest.post(Routes13.webhook(id, token), {
  ...
  async executeSlack(id, token, body, query = {}, { signal } = {}) {
    await this.rest.post(Routes13.webhookPlatform(id, token, "slack"), {
  ...
  async executeGitHub(id, token, body, query = {}, { signal } = {}) {
    await this.rest.post(Routes13.webhookPlatform(id, token, "github"), {
      query: makeURLSearchParams7(query),
      body,
      signal,
      auth: false
  ...
  async getMessage(id, token, messageId, query = {}, { signal } = {}) {
    return this.rest.get(Routes13.webhookMessage(id, token, messageId), {
      query: makeURLSearchParams7(query),
      auth: false,
      signal
    });
  ...
  async editMessage(id, token, messageId, {
    ...
    return this.rest.patch(Routes13.webhookMessage(id, token, messageId), {
  ...
  async deleteMessage(id, token, messageId, query = {}, { signal } = {}) {
    await this.rest.delete(Routes13.webhookMessage(id, token, messageId), {
      query: makeURLSearchParams7(query),
      auth: false,
      signal
    });
